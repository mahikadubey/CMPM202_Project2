...
BATCH_SIZE = 5
N_ITERATION = 10000
IMAGE_WIDTH = 378   # 1/4 the size
IMAGE_HEIGHT = 504  # 1/4 the size
IMAGE_EXT ='jpg'

TRAIN_GT_DATASET_PATH ='dataset/train/portrait'
TRAIN_NOISY_DATASET_PATH ='dataset/train/original'
VAL_GT_DATASET_PATH ='dataset/val/portrait'
VAL_NOISY_DATASET_PATH ='dataset/val/original'
